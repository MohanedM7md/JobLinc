        ...
        <div className="flex h-screen w-full bg-charcoalWhite items-center justify-center">
            ...
            <form onSubmit={isValidSubmit}>
                <div className="flex flex-col w-80 gap-4 bg-lightGray p-5 rounded-xl">
                    <h1 className="text-warmBlack text-[20px] font-bold">Change Password</h1>
                    <PasswordFieldNormal labelText="Old password *" passwordText={oldPassText} setPasswordText={setOldPassText} showErrorPassEmpty={showErrorOldPassEmpty} setshowErrorPassEmpty={setShowErrorOldPassEmpty} showErrorPassInvalid={showErrorOldPassInvalid} setshowErrorPassInvalid={setShowErrorOldPassInvalid} />
                    <PasswordFieldNormal labelText="New password *" passwordText={newPassText} setPasswordText={setNewPassText} showErrorPassEmpty={showErrorNewPassEmpty} setshowErrorPassEmpty={setShowErrorNewPassEmpty} showErrorPassInvalid={showErrorNewPassInvalid} setshowErrorPassInvalid={setShowErrorNewPassInvalid} />
