        ...
        <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-4 w-130">
                    ...
                    <div className="flex w-full flex-col items-center justify-center">
                        <div className="text-[15px] text-mutedSilver mb-3">
                            By clicking Continue to join or sign in, you agree to the JobLinc's{" "}
                            <span className="text-softRosewood font-semibold hover:underline hover:cursor-pointer">User Agreement</span>,{" "}
                            <span className="text-softRosewood font-semibold hover:underline hover:cursor-pointer">Privacy Policy</span>,{" "}
                            <span className="text-softRosewood font-semibold hover:underline hover:cursor-pointer">Cookie Policy.</span>
                        </div>
                    </div>
            ...
            <div className="bg-warmWhite w-full mt-35 grid grid-cols-2 gap-15 p-15">
                ...
                <div className="flex gap-3 flex-wrap">
                    ...
                    {buttonsArticles.map((btnText) => <ExploreButtons key={btnText} text={btnText} />)}
                </div>
            </div>
            ...
            <div className="w-full grid grid-cols-2 gap-15 p-15">
                ...
                <div className="flex gap-3 flex-wrap">
                    {/* HERE WE WILL HAVE A LIST OF BUTTONS */}
                    {buttonsJobs.map((btnText) => <ExploreButtons key={btnText} text={btnText} />)}
                    {showMoreJobs && buttonsMoreJobs.map((btnText) => <ExploreButtons key={btnText} text={btnText} />)}
                    <button onClick={() => setShowMoreJobs(!showMoreJobs)} className="flex items-center rounded-3xl bg-warmWhite text-[18px] font-semibold outline-4 outline-softRosewood px-6 py-3 hover:cursor-pointer">
                        {showMoreJobs ? (
                            <>
            ...
            <div className="bg-warmWhite w-full flex flex-col justify-center items-center gap-15 p-15">
                <div className="flex flex-col gap-4">
                    <h2 className="text-4xl text-softRosewood">Post your job for millions of people to see</h2>
                </div>
                <div className="flex gap-3 flex-wrap">
                    <button className="rounded-3xl text-[18px] font-semibold outline-3 text-warmBlack outline-softRosewood px-6 py-3 hover:cursor-pointer">Post a job</button>
                </div>
            </div>
            ...
            <div className="w-full grid grid-cols-2 gap-15 p-15">
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-2xl">Connect with buyers who have first-hand experience to find the best products for you.</p>
                </div>
                <div className="flex gap-3 flex-wrap">
                    {/* HERE WE WILL HAVE A LIST OF BUTTONS */}
                    {buttonsSoftware.map((btnText) => <ExploreButtons key={btnText} text={btnText} />)}
                </div>
            </div>
            ...
            <div className="w-full grid grid-cols-2 gap-15 p-15 bg-warmWhite">
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-2xl">Take a break and reconnect with your network through quick daily games.</p>
                </div>
                <div className="flex gap-3 flex-wrap">
                    {/* HERE WE WILL HAVE A LIST OF BUTTONS */}
                    {buttonsGames.map((btnText) => <ExploreButtons key={btnText} text={btnText} />)}
                </div>
            </div>
            ...
            <div className="w-full grid grid-cols-[20%_60%_20%] justify-center items-center gap-10 p-40">
                <div className="flex items-center justify-center w-full">
                    <button onClick={handlePrevFeature} className="rounded-3xl px-6 py-3 bg-warmWhite text-[18px] font-semibold outline-4 text-warmBlack outline-warmBlack hover:cursor-pointer flex items-center">
                ...
                <div className="flex justify-center w-full">
                    <button onClick={handleNextFeature} className="rounded-3xl px-6 py-3 bg-warmWhite text-[18px] font-semibold outline-4 text-warmBlack outline-warmBlack hover:cursor-pointer flex items-center">
                        Forward
            ...
            {/* Join JobLinc */}
            <div className="w-full flex flex-col justify-center gap-15 p-15" style={{ backgroundImage: 'url(https://example.com/your-image.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className="flex flex-col gap-15">
                    <h2 className="text-warmBlack text-4xl">Join your colleagues, classmates, and friends on JobLinc</h2>
                    <div>
                        <button className={`rounded-3xl px-6 py-3 bg-warmWhite text-[18px] font-semibold outline-4 text-softRosewood outline-softRosewood hover:cursor-pointer`}>
            ...
            <div className="w-full flex justify-center items-stretch gap-15 p-15 bg-lightGray">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <Link className="hover:underline" to="/">Press</Link>
                    <Link className="hover:underline" to="/">Blog</Link>
                    <Link className="hover:underline" to="/">Careers</Link>
                    <Link className="hover:underline" to="/">Developers</Link>
                </div>
                <div className="flex flex-col gap-5">
                    <strong>Browse JobLinc</strong>
                    <Link className="hover:underline" to="/">Learning</Link>
                    <Link className="hover:underline" to="/">Jobs</Link>
                    <Link className="hover:underline" to="/">Games</Link>
                    <Link className="hover:underline" to="/">Salary</Link>
                    <Link className="hover:underline" to="/">Mobile</Link>
                    <Link className="hover:underline" to="/">Services</Link>
                    <Link className="hover:underline" to="/">Products</Link>
                    <Link className="hover:underline" to="/">Top Companies Hub</Link>
                </div>
                <div className="flex flex-col gap-5">
                    <strong>Business Solutions</strong>
                    <Link className="hover:underline" to="/">Talent</Link>
                    <Link className="hover:underline" to="/">Marketing</Link>
                    <Link className="hover:underline" to="/">Sales</Link>
                    <Link className="hover:underline" to="/">Learning</Link>
                </div>
                <div className="flex flex-col gap-5">
                    <strong>Directories</strong>
                    <Link className="hover:underline" to="/">Members</Link>
                    <Link className="hover:underline" to="/">Jobs</Link>
                    <Link className="hover:underline" to="/">Companies</Link>
                    <Link className="hover:underline" to="/">Featured</Link>
                    <Link className="hover:underline" to="/">Learning</Link>
                    <Link className="hover:underline" to="/">Posts</Link>
                    <Link className="hover:underline" to="/">Articles</Link>
                    <Link className="hover:underline" to="/">Schools</Link>
                    <Link className="hover:underline" to="/">News</Link>
                    <Link className="hover:underline" to="/">News Letters</Link>
                    <Link className="hover:underline" to="/">Services</Link>
                    <Link className="hover:underline" to="/">Products</Link>
                    <Link className="hover:underline" to="/">Advice</Link>
                    <Link className="hover:underline" to="/">People Search</Link>
                </div>
            </div>
