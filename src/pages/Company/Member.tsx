...
function Member()
{
    ...
    const selectedNavItem = navItems.find(item => item.text === navItemSelected);
    ...
    <div className="bg-warmWhite min-h-screen w-full flex flex-col items-center">
        ...
        <div className="bg-crimsonRed flex flex-row justify-evenly items-center h-[100px] w-full top-0 mb-10">
            ...
            <div>
                ...
                onClick={() => {navigate(`/company/admin/${companyId}`)}}>View as admin</button>
            </div>
        </div>
        ...
        <div className="rounded-xl bg-white flex flex-col top-[150px] w-[800px]">
            <div className="border-b-1 border-b-gray-600 p-5">
                ...
                <div className="info-container flex flex-col gap-5">
                    ...
                    <p className="text-[18px] text-gray-500">{company.industry} . {company.followers} followers . {company.employees} employees</p>
                    <div className="flex gap-8">
                        <button className="bg-crimsonRed text-white px-5 py-2 rounded-2xl hover:cursor-pointer hover:bg-darkBurgundy flex gap-2 font-semibold"> <Plus /> Follow</button>
                        <button className="px-5 py-2 rounded-2xl hover:cursor-pointer outline-1 outline-crimsonRed hover:outline-2 flex gap-2 font-semibold"> <MessageCircle /> Message</button>
                        <button className="outline-1 w-[40px] font-bold px-2 py-2 rounded-4xl hover:outline-2 hover:cursor-pointer flex justify-center items-center"> <EllipsisVertical /> </button>
                    </div>
                </div>
            </div>
