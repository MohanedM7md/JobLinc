...
describe("ForgotPassword Component Rendering", () => {
    it("renders all expected elements correctly", () => {
        ...
        expect(screen.getByText("We'll send a verification code to this Email if it matches an existing JobLinc account.")).toBeInTheDocument();
    });
    ...
    it("simulates the forgotPassword API request", async () => {
        ...
        fireEvent.change(emailInput, { target: { value: "omar.ashrafofficial1@gmail.com" } });
        ...
        expect(forgotPassword).toHaveBeenCalledWith({ email: "omar.ashrafofficial1@gmail.com" });
    });
    ...
    it("simulates the forgotPassword API request", async () => {
        ...
        // Ensure forgotPassword was called with the correct payload
        expect(forgotPassword).toHaveBeenCalledWith({ email: "omar.ashrafofficial1@gmail.com" }, expect.anything());
    });
