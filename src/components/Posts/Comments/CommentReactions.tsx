...
import { getCommentReactions } from "@services/api/postServices";
...
export default function CommentReactions(props: CommentReactionInterface) {
  const {
    data: reactionsData,
    ...
    queryKey: ["Get all comment reactions", props.commentId],
    queryFn: () => getCommentReactions(props.commentId),
    enabled: true,
        ...
        {isReactionsFetching ? (
          <div className="w-full flex flex-col">
            {[1, 2, 3].map((item) => (
              ...
              >
                <div className="rounded-full h-16 w-16 m-4 bg-gray-600"></div>
