...
function SignInInformation() {
  ...
  return (
    <form
      ...
      className="flex flex-col w-80 items-start gap-3"
    >
      ...
      <Modal
        data-testid="wrong-email-or-password"
        isOpen={isWrongEmailOrPassword}
        onClose={() => setIsWrongEmailOrPassword(false)}
      >
