...
function UserDetails() {
  ...
  const [showErrorFirstNameInvalid, setShowErrorFirstNameInvalid] =
    useState(false);

  const [showErrorLastNameEmpty, setShowErrorLastNameEmpty] = useState(false);
  const [showErrorLastNameInvalid, setShowErrorLastNameInvalid] =
    useState(false);
  ...
  async function handleSubmitPhoneNo(event: React.FormEvent) {
    ...
    event.preventDefault();
    if (
      isValidPhoneNo(selectedCountry, phoneNumber) ||
  ...
  return (
    <div className="flex flex-col gap-4 w-full h-screen items-center justify-center">
      ...
      <div className="flex flex-col gap-3 bg-lightGray p-5 rounded-xl w-full max-w-md">
        ...
        >
          ...
          <NameFieldNormal
            ...
            val={firstName}
            setVal={setFirstName}
            showErrorEmpty={showErrorFirstNameEmpty}
            setShowErrorEmpty={setShowErrorFirstNameEmpty}
            showErrorInvalid={showErrorFirstNameInvalid}
            setShowErrorInvalid={setShowErrorFirstNameInvalid}
          />
          ...
          <NameFieldNormal
            ...
            val={lastName}
            setVal={setLastName}
            showErrorEmpty={showErrorLastNameEmpty}
            setShowErrorEmpty={setShowErrorLastNameEmpty}
            showErrorInvalid={showErrorLastNameInvalid}
            setShowErrorInvalid={setShowErrorLastNameInvalid}
          />
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        >
          ...
          <div className="flex flex-col w-full gap-2">
            <label htmlFor="countries" className="text-[12px]">
              Select country *
            </label>
            <select
              id="countries"
          ...
          <div className="flex flex-col w-full gap-2">
            <label htmlFor="cities" className="text-[12px]">
              Select city *
            </label>
            <select
              id="cities"
          ...
          <div className="flex flex-col w-full gap-2">
            <label htmlFor="phone-number" className="text-[12px]">
              Phone number
            </label>
      ...
      <Modal
        ...
        onClose={() => setIsModalOpenError(false)}
      >
        <div className="flex flex-col items-start gap-4 w-full">
          ...
          <p className="text-[18px]">
            ...
            <Link
              ...
              className="text-warmBlack font-bold hover:underline hover:cursor-pointer"
            >
              Forgot password
            </Link>
          </p>
