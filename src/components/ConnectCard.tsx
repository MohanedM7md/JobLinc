    ...
    return(
        <div className="border-2 border-gray-200 rounded-xl flex flex-col w-70 h-80 justify-center items-center">
            ...
            <div className=" relative flex flex-col w-full h-13/20 justify-center items-center">
                ...
                <button
                onClick={handleClick}
                className={`border-2 px-15 py-0.5 ${isClicked ? "text-darkGray border-darkGray" : "text-crimsonRed border-crimsonRed"} rounded-full font-semibold hover:bg-lightGray`}>
