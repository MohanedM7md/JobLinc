  ...
  return (
    ...
    >
        ...
        <ul className="space-y-2 text-gray-600">
          <li>
            <Link
              ...
              to={`/profile/${userId}`}
            >
              <button className="cursor-pointer border-2 px-15 py-0.5 rounded-full font-semibold hover:bg-lightGray hover:outline-1 text-crimsonRed border-crimsonRed">
                View Profile
              </button>
            </Link>
          </li>
          <li>
            <Link className="hover:text-blue-400 duration-300" to="#">
              Try 1 month of Premium for EGP0
            </Link>
          </li>
          <li>
      ...
      <div className="final py-2 text-gray-600">
        <Link className="hover:underline" to="#" onClick={handleSignOut}>
          Sign Out
        </Link>
      </div>
    </div>
