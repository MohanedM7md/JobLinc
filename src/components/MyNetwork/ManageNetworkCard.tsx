...
const ManageNetworkCard: React.FC = () => {
  return (
    <div className="flex-col items-center bg-white lg:w-70 w-full ml-0 lg:ml-[5%] border rounded-md border-gray-200 shadow-sm mt-5">
      ...
      <ManageNetworkIcons id="ConnectionsButton"Icon="fa-solid fa-user-group" IconName="Connections" Number="60" />
      ...
      <ManageNetworkIcons id="PagesButton"Icon="fa-solid fa-building" IconName="Pages" Number="12" />
